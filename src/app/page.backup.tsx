          ...
          <>
            ...
            <div className="mx-auto max-w-5xl rounded-3xl border border-white/10 bg-white/[0.035] p-5 shadow-2xl sm:p-7">
              ...
              <textarea
                ...
                placeholder="Example: एक लड़का अपने पुराने घर में एक रहस्यमयी घड़ी खोजता है जो समय रोक सकती है..."
            ...
            <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-white/40">
                  {result.scenes.length} scenes · {language} ·{" "}
                  {style} · {duration}
                </p>
              </div>
              ...
              <aside className="h-fit rounded-3xl border border-white/10 bg-white/[0.035] p-5 xl:sticky xl:top-24">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select className="w-full rounded-xl border border-white/10 bg-[#101117] px-4 py-3 text-sm outline-none">
                  ...
                  <div>
                    ...
                    <select className="w-full rounded-xl border border-white/10 bg-[#101117] px-4 py-3 text-sm outline-none">
                      <option>AI Voice · Natural</option>
                      <option>AI Voice · Deep</option>
                      <option>AI Voice · Soft</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <button className="flex w-full items-center justify-between rounded-xl border border-white/10 bg-[#101117] px-4 py-3 text-sm">
